...
return [
    ...
    */
    ...
    'exists'               => 'O campo :attribute selecionado não foi encontrado.',
    ...
    */
    ...
    'custom' => [
        'senha' => [
            'confirmed' => 'A :attribute e a confirmação de :attribute devem combinar.',
            'regex' => 'O campo :attribute deve conter uma letra maiúscula, uma letra minúscula e pelo menos dois números',
        ],
    ],
